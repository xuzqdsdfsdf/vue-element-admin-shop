...
width="80"
      ...
      <el-table-column label="视频内容" width="300px">
        <template slot-scope="{row}">
...
label-width="70px"
        ...
        <el-form-item label="视频标题" prop="title" label-width="80px">
          <el-input v-model="temp.title" />
        </el-form-item>
        <el-form-item label="封面图片" prop="cover" label-width="80px">
          <el-upload
...
:file-list="fileList">
            ...
            <div slot="tip" class="el-upload__tip">
              格式只支持.mp4,.avi,.wmv,.mov,.flv,.rmvb,.3gp,.m4v,.mkv为保证播放的流畅性，请勿上传超过5G的文件</div>
          </el-upload>
        </el-form-item>
        ...
        <el-form-item label="课程价格" prop="price" label-width="80px">
    ...
    updateData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          tempData.created_at = +new Date(tempData
            .created_at) // change Thu Nov 30 2017 16:41:05 GMT+0800 (CST) to 1512031311464
